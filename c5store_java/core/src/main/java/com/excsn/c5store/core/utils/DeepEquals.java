package com.excsn.c5store.core.utils;
...
/**
 * Attribution: https://github.com/jdereg/java-util/blob/master/src/main/java/com/cedarsoftware/util/DeepEquals.java
 * Class was altered to:
 * - to exclude the custom object field checks.
 * - Use collections.emptymap instead of spawning of empty hashmap on each invokation
 */
...
public class DeepEquals {
  ...
  public static boolean deepEquals(Object a, Object b) {
    return deepEquals(a, b, Collections.EMPTY_MAP);
  }
